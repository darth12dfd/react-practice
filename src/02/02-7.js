...
//ES6은 참조 순서에 따른 의존성 문제를 import 구문을 사용하여 script 엘리먼트 없이 견결된 파일 및 의존 파일을 먼저 모두 내려받고 코드를 구동하도록 변경함으로써 해결했다.
import MyModule from "./MyModule";//import 구문을 사용해 지정된 파일의 기본으로 공유하는 모듈을 부른다.
import { ModuleName } from "./MyModule";//이름을 맞춰 모듈 안의 특정 함수 혹은 변수를 참조할 수도 있다.
