...
var notificationReducer_initState = {
  message: '',
  warning: false,
  showMessage: false
};
/* harmony default export */ var notificationReducer = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : notificationReducer_initState;
...
/* harmony default export */ var createReducers = (function () {
  ...
  return reducerNames.reduce(function (apiReducers, name) {
    ...
    var initState = {
      ids: [],
      entities: {},
      loadingState: (_loadingState = {}, Object(defineProperty["a" /* default */])(_loadingState, "".concat(actionTypes["a" /* CREATE */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_loadingState, "".concat(actionTypes["e" /* UPDATE */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_loadingState, "".concat(actionTypes["b" /* FETCH */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_loadingState, "".concat(actionTypes["c" /* FETCH_LIST */], "/").concat(name), false), _loadingState),
      errorState: (_errorState = {}, Object(defineProperty["a" /* default */])(_errorState, "".concat(actionTypes["a" /* CREATE */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_errorState, "".concat(actionTypes["e" /* UPDATE */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_errorState, "".concat(actionTypes["b" /* FETCH */], "/").concat(name), false), Object(defineProperty["a" /* default */])(_errorState, "".concat(actionTypes["c" /* FETCH_LIST */], "/").concat(name), false), _errorState),
      pagination: {},
      pages: {}
    };
            ...
            return Object(external_redux_pack_["handle"])(state, action, {
              start: function start(prevState) {
                return Object(objectSpread["a" /* default */])({}, prevState, {
                  loadingState: Object(objectSpread["a" /* default */])({}, prevState.loadingState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), true)),
                  errorState: Object(objectSpread["a" /* default */])({}, prevState.errorState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false))
                });
              },
              success: function success(prevState) {
                ...
                if (type === actionTypes["c" /* FETCH_LIST */]) {
                  ...
                  var entities = data.reduce(function (finalEntities, entity) {
                    return Object(objectSpread["a" /* default */])({}, finalEntities, Object(defineProperty["a" /* default */])({}, entity[key], entity));
                  }, {});
                  return Object(objectSpread["a" /* default */])({}, prevState, {
                    ids: ids,
                    entities: Object(objectSpread["a" /* default */])({}, prevState.entities, entities),
                    loadingState: Object(objectSpread["a" /* default */])({}, prevState.loadingState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false)),
                    errorState: Object(objectSpread["a" /* default */])({}, prevState.errorState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false)),
                    pagination: {
                      number: pageNumber,
                      size: pageSize
                    },
                    pages: Object(objectSpread["a" /* default */])({}, prevState.pages, Object(defineProperty["a" /* default */])({}, pageNumber, ids))
                  });
                } else {
                  var id = data[key];
                  return Object(objectSpread["a" /* default */])({}, prevState, {
                    id: id,
                    entities: Object(objectSpread["a" /* default */])({}, prevState.entities, Object(defineProperty["a" /* default */])({}, id, data)),
                    loadingState: Object(objectSpread["a" /* default */])({}, prevState.loadingState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false)),
                    errorState: Object(objectSpread["a" /* default */])({}, prevState.errorState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false))
                  });
                }
              ...
              failure: function failure(prevState) {
                ...
                return Object(objectSpread["a" /* default */])({}, prevState, {
                  loadingState: Object(objectSpread["a" /* default */])({}, prevState.loadingState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), false)),
                  errorState: Object(objectSpread["a" /* default */])({}, prevState.errorState, Object(defineProperty["a" /* default */])({}, "".concat(type, "/").concat(name), errorMessage || true))
                });
              }
            });
          }
...
var reducers_apiReducers = createReducers('transactions', 'users'); //11-5-3. users 리듀서 추가하기
    ...
    return function (action) {
      ...
      if (meta && meta.notification) {
        ...
        if (success && meta[external_redux_pack_["KEY"].LIFECYCLE] === external_redux_pack_["LIFECYCLE"].SUCCESS) {
          ...
          store.dispatch(notificationActions_showMessage(errorMessage || error, true));
...
function parse(qs) {
  ...
  return chunks.map(function (chunk) {
    ...
    return Object(objectSpread["a" /* default */])({}, result, Object(defineProperty["a" /* default */])({}, key, value));
  }, {});
}
...
// CONCATENATED MODULE: ./src/doit-ui/Modal/create.jsx
...
function create_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function TradeCoinPage_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function RegisterPage_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function userActions_createUser(data, onComplete) {
  return create(data, {}, {
    notification: {
...
/* harmony default export */ var RegisterPageContainer = (Object(external_react_redux_["connect"])(function (state) {
  ...
  createUser: userActions_createUser
})(signup_RegisterPage));
...
/* harmony default export */ var _08_ModalProvider = (createModalProvider((_createProvider = {}, Object(defineProperty["a" /* default */])(_createProvider, modals["b" /* TRADE_COIN_MODAL */], TradeCoinPageContainer), Object(defineProperty["a" /* default */])(_createProvider, modals["a" /* REGISTER_USER_MODAL */], RegisterPageContainer), _createProvider)));
...
function AppNav_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function AppLayout_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function Toast_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function Notification_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function RouterStateContainer_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function _app_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !construct_default.a) return false; if (construct_default.a.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(construct_default()(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var _app_MyApp = /*#__PURE__*/function (_App) {
  ...
  Object(createClass["a" /* default */])(MyApp, [{
    ...
    value: function render() {
      ...
      var Router = isServer ? external_react_router_["StaticRouter"] : external_react_router_dom_["BrowserRouter"]; //next.js에는 브라우저 객체가 없으므로 StaticRouter를 사용하여 화면을 출력해야 한다. 서버 출력 이후 자바스크립트가 동작하면 BrowserRouter로 화면을 출력하도록 구성한다.
